...
2. Workspace
Represents workspaces where users organize their content. Each user can create multiple workspaces. In reality, multiple users can work on one workspace, but for simplicity, in my ERD I assumed that each workspace only belongs to one user.
